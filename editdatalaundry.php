  ...
  <hr>
        <div class="row">
          <div class="col-md-4">
            ...
            $sql = mysqli_query($conn, "SELECT laundry.*, pelanggan.nama from laundry, pelanggan where pelanggan.id_pelanggan=laundry.id_pelanggan AND no_order='$No_Order'");
            $hasil = mysqli_fetch_assoc($sql);
              ?>
            <form name="form" action="proses-tambah-transaksi.php?no_order=<?= $No_Order; ?>" method="POST" >
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="total_berat" readonly class="form-control" name="total_berat" placeholder="Total Berat" value="<?php echo $hasil['berat']; ?>">
                </div>
                <div class="form-group">
